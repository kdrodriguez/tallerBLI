...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI1216_bli_busquedacliente")
})
public class BLI1216_bli_busquedacliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI1216_bli_busquedacliente.class);
