/*
 * Archivo: T_INTRDJEEIIIOD_692.java
 * Fecha: 2021-02-06T02:39:41Z
 *
 ...
 * T_INTRDJEEIIIOD_692 - FormImpresora 
 *
 */
@Path("/INTRD/FRMSP/T_INTRDJEEIIIOD_692")
@Component
@Service({T_INTRDJEEIIIOD_692.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=INTRD)(task.submodule=FRMSP)(task.id=T_INTRDJEEIIIOD_692)(task.version=1.0.0))")
,@Reference(name="VW_IMPRESORAA_799", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_IMPRESORAA_799)(view.version=1.0.0))")
...
public class T_INTRDJEEIIIOD_692 {
