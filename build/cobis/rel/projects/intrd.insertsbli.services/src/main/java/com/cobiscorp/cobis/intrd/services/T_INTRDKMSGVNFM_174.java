/*
 * Archivo: T_INTRDKMSGVNFM_174.java
 * Fecha: 2021-02-06T02:42:28Z
 *
 ...
 * T_INTRDKMSGVNFM_174 - FormFestivos 
 *
 */
@Path("/INTRD/FRMSP/T_INTRDKMSGVNFM_174")
@Component
@Service({T_INTRDKMSGVNFM_174.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=INTRD)(task.submodule=FRMSP)(task.id=T_INTRDKMSGVNFM_174)(task.version=1.0.0))")
,@Reference(name="VW_FESTIVOSAN_121", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_FESTIVOSAN_121)(view.version=1.0.0))")
...
public class T_INTRDKMSGVNFM_174 {
